...
@overload
def Header(alias: Optional[str] = None, *, default_factory: Callable[[], T], required: bool = False) -> T: ...
@overload
...
@overload
def Query(alias: Optional[str] = None, *, default_factory: Callable[[], T], required: bool = False) -> T: ...
@overload
def Path(alias: Optional[str] = None, *, required: bool = False) -> Any: ...
@overload
def Path(alias: Optional[str] = None, *, default: T, required: bool = False) -> T: ...
@overload
def Path(alias: Optional[str] = None, *, default_factory: Callable[[], T], required: bool = False) -> T: ...
@overload
...
@overload
def Cookie(alias: Optional[str] = None, *, default_factory: Callable[[], T], required: bool = False) -> T: ...
@overload
def Body(alias: Optional[str] = None, *, required: bool = False) -> Any: ...
@overload
def Body(alias: Optional[str] = None, *, default: T, required: bool = False) -> T: ...
@overload
def Body(alias: Optional[str] = None, *, default_factory: Callable[[], T], required: bool = False) -> T: ...
def Headers() -> Any: ...
def Queries() -> Any: ...
def Cookies() -> Any: ...
