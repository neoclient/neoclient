...
from .consumers import (ContentConsumerFactory, CookieConsumerFactory,
                        CookiesConsumerFactory, DataConsumerFactory,
                        FilesConsumerFactory, HeaderConsumerFactory,
                        HeadersConsumerFactory, JsonConsumerFactory,
                        PathParamConsumerFactory, PathParamsConsumerFactory,
                        QueryParamConsumerFactory, QueryParamsConsumerFactory,
