...
def test_QueryResolver_resolve_request() -> None:
    request_with_param: RequestOpts = utils.build_pre_request(
        params={"name": "sam"},
    )
    request_without_param: RequestOpts = utils.build_pre_request()
...
def test_HeaderResolver_resolve_request() -> None:
    request_with_header: RequestOpts = utils.build_pre_request(
        headers={"name": "sam"},
    )
    request_without_header: RequestOpts = utils.build_pre_request()
...
def test_CookieResolver_resolve_request() -> None:
    request_with_cookie: RequestOpts = utils.build_pre_request(
        cookies={"name": "sam"},
    )
    request_without_cookie: RequestOpts = utils.build_pre_request()
...
def test_QueryParamsResolver_resolve_request() -> None:
    request: RequestOpts = utils.build_pre_request(
        params={"name": "sam"},
    )
