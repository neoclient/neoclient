...
from neoclient.models import RequestOptions, State
from neoclient.types import JsonTypes, RequestContent, RequestData, RequestFiles


@fixture
def pre_request() -> RequestOptions:
    return RequestOptions("GET", "/foo")


def test_consumer_query_param(pre_request: RequestOptions) -> None:
    key: str = "name"
    value: str = "sam"

    expected_pre_request: RequestOptions = pre_request.clone()
...
def test_consumer_header(pre_request: RequestOptions) -> None:
    key: str = "name"
    value: str = "sam"
...
def test_consumer_cookie(pre_request: RequestOptions) -> None:
    key: str = "name"
    value: str = "sam"
...
def test_consumer_path_param(pre_request: RequestOptions) -> None:
    key: str = "name"
    value: str = "sam"
...
def test_consumer_query_params(pre_request: RequestOptions) -> None:
...
def test_consumer_headers(pre_request: RequestOptions) -> None:
...
def test_consumer_cookies(pre_request: RequestOptions) -> None:
...
def test_consumer_path_params(pre_request: RequestOptions) -> None:
...
def test_consumer_content(pre_request: RequestOptions) -> None:
...
def test_consumer_data(pre_request: RequestOptions) -> None:
...
def test_consumer_files(pre_request: RequestOptions) -> None:
...
def test_consumer_json(pre_request: RequestOptions) -> None:
...
def test_consumer_timeout(pre_request: RequestOptions) -> None:
...
def test_consumer_state(pre_request: RequestOptions) -> None:
...
def test_FollowRedirectsConsumer(pre_request: RequestOptions) -> None:
